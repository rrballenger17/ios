...
class PlaySoundsViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if let saved:Float = NSUserDefaults.standardUserDefaults().valueForKey("slider") as? Float{
            sliderView.value = saved
        }
    ...
    @IBAction func sliderDidMove(sender: UISlider) {
        ...
        NSUserDefaults.standardUserDefaults().setValue(sliderView.value, forKey: "slider")
